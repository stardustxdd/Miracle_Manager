...
public class UpdaterActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				intent.setClass(getApplicationContext(), ManagerActivity.class);
		...
		_ChekUpdate_request_listener = new RequestNetwork.RequestListener() {
			@Override
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				try{
					UpdateResponce = new Gson().fromJson(_response, new TypeToken<HashMap<String, Object>>(){}.getType());
				} catch (Exception e) {
					SketchwareUtil.showMessage(getApplicationContext(), "Unable to load data from server !!");
				}
				if (!UpdateResponce.isEmpty()) {
					try{
						if (Double.parseDouble(UpdateResponce.get("Manager_Latest_Version_Code").toString()) > VersionCode) {
							textview1.setText("Version ".concat(UpdateResponce.get("Manager_Latest_Version").toString().concat(" ").concat("Update Is Available !!")));
							UpdateLinkDn = UpdateResponce.get("Manager_Latest_Download_Link").toString();
							textview2.setText("Please update your Miracle Manager to the latest version.");
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				SketchwareUtil.showMessage(getApplicationContext(), "Server or internet error !!");
			}
		};
	...
	private void initializeLogic() {
		...
		PRDownloaderConfig config = PRDownloaderConfig.newBuilder()
			...
			.build();
		PRDownloader.initialize(UpdaterActivity.this, config);
		linear9.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
					...
					downloadId = PRDownloader.download(UpdateLinkDn
				, "/storage/emulated/0/TeamMiracle", "Miracle_Manager.apk")
						.build()
					...
					.start(new OnDownloadListener() {
						...
						progressbar2.setVisibility(View.GONE);
						textview1.setText("Download Finished");
						FileUtil.writeFile("t", "t");
						try {
							if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
													Uri uri = androidx.core.content.FileProvider.getUriForFile(getApplicationContext(),
															UpdaterActivity.this.getPackageName() + ".provider", new java.io.File("/storage/emulated/0/TeamMiracle/".concat("Miracle_Manager.apk")));
													...
													Intent intent = new Intent(Intent.ACTION_VIEW);
													intent.setDataAndType(Uri.fromFile( new java.io.File("/storage/emulated/0/TeamMiracle/".concat("Miracle_Manager.apk"))),
